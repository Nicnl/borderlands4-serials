...
var testsGroups = []struct {
	...
	},
	{
		...
		tests: []test{
			{
				bits: "00000 0:01 [01 100-00000 00]",
				expected: Part{
					Index:   0,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{0},
			...
			{
				bits: "00000 0:01 [01 100-10000 00]",
				expected: Part{
					Index:   0,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{1},
			...
			{
				bits: "00000 0:01 [01 100-01000 00]",
				expected: Part{
					Index:   0,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{2},
			...
			{
				bits: "00000 0:01 [01 100-00100 00]",
				expected: Part{
					Index:   0,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{4},
			...
			{
				bits: "00000 0:01 [01 100-00010 00]",
				expected: Part{
					Index:   0,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{8},
			...
			{
				bits: "00000 0:01 [01 100-00001-10000 00]",
				expected: Part{
					Index:   0,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{16},
			...
			{
				bits: "00000 0:01 [01 100-00001-01000 00]",
				expected: Part{
					Index:   0,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{32},
			...
			{
				bits: "00000 0:01 [01 100-00001-00100 00]",
				expected: Part{
					Index:   0,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{64},
			...
			{
				bits: "00000 0:01 [01 100-00001-00010 00]",
				expected: Part{
					Index:   0,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{128},
			...
			{
				bits: "10000 0:01 [01 100-00001-00010 00]",
				expected: Part{
					Index:   1,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{128},
			...
			{
				bits: "01000 0:01 [01 100-00001-00010 00]",
				expected: Part{
					Index:   2,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{128},
			...
			{
				bits: "00100 0:01 [01 100-00001-00010 00]",
				expected: Part{
					Index:   4,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{128},
			...
			{
				bits: "00010 0:01 [01 100-00001-00010 00]",
				expected: Part{
					Index:   8,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{128},
			...
			{
				bits: "00001-10000 0:01 [01 100-00001-00010 00]",
				expected: Part{
					Index:   16,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{128},
			...
			{
				bits: "00001-01000 0:01 [01 100-00001-00010 00]",
				expected: Part{
					Index:   32,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{128},
			...
			{
				bits: "00001-00100 0:01 [01 100-00001-00010 00]",
				expected: Part{
					Index:   64,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{128},
			...
			{
				bits: "00001-00010 0:01 [01 100-00001-00010 00]",
				expected: Part{
					Index:   128,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{128},
	...
	},
	{
		...
		tests: []test{
			...
			{
				bits: "11110 0:01 [01 100-00000 00]",
				expected: Part{
					Index:   15,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{0},
			...
			{
				bits: "11110 0:01 [01 100-10000 100-00000 00]",
				expected: Part{
					Index:   15,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{1, 0},
			...
			{
				bits: "11110 0:01 [01 100-01000 100-10000 100-00000 00]",
				expected: Part{
					Index:   15,
					SubType: SUBTYPE_LIST,
					Values:  []uint32{2, 1, 0},
			...
			{
				bits: "11110 0:01 [01 100-00100 100-01000 100-10000 100-00000 00]",
				expected: Part{
					Index:   15,
					SubType: SUBTYPE_LIST,
			...
			{
				bits: "11110 0:01 [01 100-00010 100-00100 100-01000 100-10000 100-00000 00]",
				expected: Part{
					Index:   15,
					SubType: SUBTYPE_LIST,
